...
import { Laptop, Tv, Wrench, Home, Camera, Dumbbell, ArrowLeft, CheckCircle2, User, Phone, MapPin, CalendarIcon, Clock } from "lucide-react";
...
const serviceCategories = [
  {
    ...
    description: "Expert diagnostics and repairs for all computer and laptop issues",
    price: "₹499",
    duration: "1-2 hours",
    popular: true,
    included: ["Hardware diagnostics", "Software repair", "Performance optimization"],
    subcategories: [
  ...
  },
  {
    ...
    description: "Professional setup and repair services for your entertainment systems",
    price: "₹599",
    duration: "2-3 hours",
    popular: false,
  ...
  },
  {
    ...
    description: "Installation and configuration of smart locks, cameras, and automation",
    price: "₹699",
    duration: "2-4 hours",
    popular: false,
  ...
  },
  {
    ...
    description: "Cooling issues, compressor repair, and preventive maintenance",
    price: "₹699",
    duration: "2-4 hours",
    popular: false,
...
const BookingDialog = ({ open, onOpenChange, preselectedCategory }) => {
  ...
  const onSubmit = (data) => {
    toast.success("Booking Confirmed!", {
      description: `Your appointment for ${selectedService?.service} has been scheduled for ${format(data.date, "PPP")} at ${data.time}`,
    });
    setTimeout(() => {
      onOpenChange(false);
      handleBack();
      ...
      <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto bg-background">
        ...
        {!selectedService ? (
          <div className="mt-4 space-y-6">
            {(filteredCategory ? [filteredCategory] : serviceCategories).map((category) => (
            ...
            <Card className="border-border/50 bg-card/50">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <CardTitle className="text-xl">{selectedService.service}</CardTitle>
                  {selectedService.category.popular && (
                    <Badge className="bg-orange-500 hover:bg-orange-600">Popular</Badge>
                  )}
                </div>
                <CardDescription>{selectedService.category.description}</CardDescription>
              </CardHeader>
